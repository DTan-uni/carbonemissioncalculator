...
st.set_page_config(layout="centered", initial_sidebar_state="collapsed", page_title="QR Scanner", page_icon="👤")
...
def correct_input(): 
    ...
    vehicle_data()
    st.session_state["page"] = "user_access"
...
if st.session_state.get("page") == "user_access":
    st.switch_page("pages/user_access.py")
